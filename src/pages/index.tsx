...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`test park`}</title>

        <meta
          name="description"
          content="Welcome to Test Park, your ultimate parking solution with a complex navigation bar and consolidated menus, all enhanced with customizable widgets."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1506521781263-d8422e82f27a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxwYXJraW5nfGVufDB8fHx8MTY5NTgwNjYxOXww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Test Park, your ultimate parking solution with a complex navigation bar and consolidated menus, all enhanced with customizable widgets.`}
            </Text>
            <Box
