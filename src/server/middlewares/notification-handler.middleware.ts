...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'Project Creation.create': { roles: ['owner', 'administrator'], key: 'project_create', tenantPath: [], userPath: [] },
  'Project Update.update': { roles: ['owner', 'administrator'], key: 'project_update', tenantPath: [], userPath: [] },
  'Design Submission.create': {
...
const tenantRoles: string[] = ['owner', 'administrator', 'developer', 'designer', 'end-user'];
