...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['owner', 'administrator', 'developer', 'designer', 'end-user'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Nav Bars', path: '/nav-bars', entity: 'nav_bar', service: AccessServiceEnum.PROJECT, icon: FiNavigation },
    { name: 'Parkings', path: '/parkings', entity: 'parking', service: AccessServiceEnum.PROJECT, icon: FiMapPin },
